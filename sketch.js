...
function setup() {
  ...
  gameOver=createSprite(width/2,height/2-60,20,20);
 ...
 restart.scale=0.1;
 bird=createSprite(50,height/2,30,30);
...
function spawnBottomObstacle(){
  if(frameCount%50===0){
    obstacle3=createSprite(width,height,20,random(200,300));
  obstacle3.velocityX=-3;
  obstacle3.shapeColor="green";
  obstacle3Group.add(obstacle3);
  console.log(obstacle3.height);

  obstacle4=createSprite(width-50,height,20,random(150,250));
